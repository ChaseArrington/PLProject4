...
var list = function() {
    var list = function () {
        ...
        f.findIndex = function(i){ // function which is returned when iterate is called
            var current = l.head;
            for(var b = 0; b < i; b++){
        ...
        var pos = 0; // variable within the closure which keeps track of last element in list returned
        f.iterate = function(){ // method called which returns a function
                pos = pos + 1;
                return f.findIndex(pos - 1);
        }
...
for (var i = 0; i < l1.length(); i++){
    document.writeln(l1.iterate() + "<BR>");
}
//var l2 = new list();
//l2.cons('c')
